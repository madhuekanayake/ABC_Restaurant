            ...
            <section id="content">
                ...
                <main>
                    ...
                    <div class="form-container">
                        <form action="${pageContext.request.contextPath}/facility_index?action=update" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <img src="${pageContext.request.contextPath}/${facility.facilityImagePath}"
                                    alt="Current Facility Image" width="100">
                            </div>
