            ...
            <section id="content">
                ...
                <main>
                    ...
                    <div class="form-container">
                        <form action="${pageContext.request.contextPath}/gallery_index?action=update" method="post"
                            enctype="multipart/form-data">
                            <input type="hidden" name="id" value="${gallery.id}">

                            <div class="form-group">
                                <label for="description">Description:</label>
                                <input type="text" id="description" name="description" value="${gallery.description}"
                                    required>
                            </div>

                            <div class="form-group">
                                <label for="galleryImage">Current Image:</label>
                                <img src="${pageContext.request.contextPath}/${gallery.galleryImagePath}"
                                    alt="Current Gallery Image" width="100">
                            </div>
