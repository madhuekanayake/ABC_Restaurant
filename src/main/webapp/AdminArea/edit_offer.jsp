    ...
    <main>
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    <li>
                        <a href="${pageContext.request.contextPath}/offer_index">Offers</a>
                    </li>
        ...
        <div class="form-container">
            <form action="${pageContext.request.contextPath}/offer_index?action=update" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="offerImage">Current Image:</label>
                    <img src="${pageContext.request.contextPath}/${offer.offerImagePath}" alt="Current Offer Image" width="100">
                </div>
                
                <div class="form-group">
                    <label for="newOfferImage">New Image (optional):</label>
                    <input type="file" id="newOfferImage" name="newOfferImage">
                </div>
