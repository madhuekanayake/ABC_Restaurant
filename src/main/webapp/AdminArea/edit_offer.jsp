            ...
            <section id="content">
                ...
                <main>
                    ...
                    <div class="form-container">
                        <form action="${pageContext.request.contextPath}/offer_index?action=update" method="post"
                            enctype="multipart/form-data">
                            <input type="hidden" name="id" value="${offer.id}">

                            <div class="form-group">
                                <label for="description">Description:</label>
                                <input type="text" id="description" name="description" value="${offer.description}"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="${pageContext.request.contextPath}/${offer.offerImagePath}"
                                    alt="Current Offer Image" width="100">
                            </div>
