            ...
            <section id="content">
                ...
                <main>
                    ...
                    <div class="form-container">
                        <form action="${pageContext.request.contextPath}/product_index?action=update" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select id="category" name="category" required>
                                    <option value="Breakfast" ${product.category=='Appetizer' ? 'selected' : '' }>
                                        Breakfast</option>
                                    <option value="Lunch" ${product.category=='Main Course' ? 'selected' : '' }>Lunch
                                    </option>
                                    <option value="Dinner" ${product.category=='Dessert' ? 'selected' : '' }>Dinner
                                    </option>
                                    <option value="Salads" ${product.category=='Beverage' ? 'selected' : '' }>Salads
                                    </option>
                                    <option value="Desserts" ${product.category=='Main Course' ? 'selected' : '' }>
                                        Desserts</option>
                                    <option value="Beverages" ${product.category=='Dessert' ? 'selected' : '' }>
                                        Beverages</option>
                                    <option value="Wine" ${product.category=='Beverage' ? 'selected' : '' }>Wine
                                    </option>
